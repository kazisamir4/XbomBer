...
def update():
    ...
    os.system("cd .. && rm -rf XBomber && git clone https://github.com/kazisamir4/XbomBer > /dev/null 2>&1")
    
    psb("\n\033[92m    [\033[37m*\033[92m] Update Complete!")
    psb("\033[92m    [\033[37m*\033[92m] Starting Tool...")
    time.sleep(0.8)
    
    os.system("cd .. && cd XbomBer && python X_Bomber")
#Logo
def logo():
    os.system("clear")
    ...
    print("\033[94m│ \033[95mAuthor : kazi samir                    \033​[94m│"​.​center​(​columns​+​15​))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033​[94m│"​.​center​(​columns​+​9​))
    print("│ \033[95mGitHub : https://github.com/kazisamir4 \033​[94m│"​.​center​(​columns​+​9​))
    print("│ \033[95mCoder  : samir             \033[37mV3.0 \033​[94m│"​.​center​(​columns​+​15​))
    print​(​"​\033​[94m└────────────────────────────────────────┘"​.​center​(​columns​+​5​))
#Options Banner
def banner():
